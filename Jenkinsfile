...
pipeline{
	...
	stages{
		...
		stage('Docker Image Release') {
            ...
            steps {
             		sh 'wget -O HelloDevOps.war http://http://3.17.20.253:8081/artifactory/devops.lab.session/com/nagarro/devops/lab/session/devops.lab/0.0.1-SNAPSHOT/devops.lab-0.0.1-SNAPSHOT.war'
